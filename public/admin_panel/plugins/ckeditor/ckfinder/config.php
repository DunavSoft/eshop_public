...
$config['LicenseKey'] = 'TMAEUHC1E6C8M';
...
Examples:
	...
	$baseDir = '/zone/admin/ckfinder/userfiles/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => "16M",
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,iso,mp3,avi,csv,doc,docx,gz,gzip,mp3,mp4,mpc,ods,odt,pdf,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,sxc,sxw,tar,tgz,tif,tiff,txt,xls,xlsx,zip',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,vsd,wav,wma,wmv,m3u',
		'deniedExtensions' => '');
