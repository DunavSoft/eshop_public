...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg"><?=lang('AccountLang.pleaseLogin')?></p>
	  ...
	  <?= form_open($locale . '/users/login', 'id="form"') ?>
        <div class="input-group mb-3">
		  <?php
			$data = [ 'type' => 'email', 'id' => 'email', 'name' => 'email', 'value' => 'admin@abv.bg', 'class' => 'form-control', 'placeholder' => lang('AccountLang.email') ];
        ...
        <div class="input-group mb-3">
		  <?php
			$data = [ 'type' => 'password', 'id' => 'password', 'name' => 'password', 'value' => '', 'class' => 'form-control', 'placeholder' => lang('AccountLang.password') ];
			echo form_input($data);
		  ?>
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="row">
          <div class="col-8">
            <div class="icheck-primary">
              ...
              <label for="remember">
                <?=lang('AccountLang.remember')?>
              </label>
            </div>
          </div>
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block"><?=lang('AccountLang.login')?></button>
          </div>
          <!-- /.col -->
        </div>
      <?= form_close() ?>
