<?php namespace App\Modules\Settings\Filters;
...
class SettingsFilter implements FilterInterface
{
	...
	public function after(RequestInterface $request, ResponseInterface $response, $arguments = null): ?ResponseInterface
	{
		...
		$settingsModel = model('App\Modules\Settings\Models\SettingsModel', false);

		$settingsArray = [];
		$settings = $settingsModel->getSettingsByLocale($request->getLocale());
